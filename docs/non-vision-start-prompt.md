...
> ⚠️ **已实施完毕，留档（2026-09-15 复核，2026-09-22 补注）**：本提示词对应的非视觉批次已在 `bfa2f91` 完成（跟踪表见 `docs/plugin-improvements.md` 六）。下文「当前版本」等状态是**当时的快照**（0.5.0-beta.0），**现已发到 `0.5.5`**；需要新批次时以跟踪表 + 该文档「七、状态同步与剩余待办影响评估」（2026-09-22）为准，**不要照本文的版本快照施工**。
>
